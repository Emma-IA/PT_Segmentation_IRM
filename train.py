...
def train():
    ...
    model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(filepath=CHECKPOINT_PATH, save_weights_only=False, verbose=1, save_best_only=False, save_format="tf")
