...
from loss import *
from metrics import *
from layers.upSampling3D import *
...
#     inputs = tf.random.normal(input_size)
    ...
    conv10 = Conv3D(2, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv9)
    conv10 = InstanceNormalization()(conv10)
    conv10 = Conv3D(4, 1)(conv10)
    print(tf.reduce_max(conv10))
    print('---------------------------------------')
    print(tf.reduce_min(conv10))
...
def small_unet(pretrained_weights = PRETRAINED_WEIGHTS,input_size = (TRAINING_IMAGE_SIZE[0],TRAINING_IMAGE_SIZE[1],TRAINING_IMAGE_SIZE[2],NUMBER_OF_CHANNELS)):
#     inputs = tf.random.normal(input_size)
    tf.random.set_seed(1234)
    inputs = Input(input_size, batch_size = BATCH_SIZE)
    conv1 = Conv3D(64, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(inputs)
    ...
    conv10 = Conv3D(32, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv8)
...
def very_small_unet(pretrained_weights = PRETRAINED_WEIGHTS,input_size = (TRAINING_IMAGE_SIZE[0],TRAINING_IMAGE_SIZE[1],TRAINING_IMAGE_SIZE[2],NUMBER_OF_CHANNELS)):
#     inputs = tf.random.normal(input_size)
    tf.random.set_seed(1234)
    inputs = Input(input_size, batch_size = BATCH_SIZE)
    ...
    up6 = Conv3D(128, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling3D(size = (2,2,1))(drop4))
    merge6 = concatenate([drop3,up6], axis = 4)
    ...
    up7 = Conv3D(64, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling3D(size = (2,2,1))(conv6))
    merge7 = concatenate([conv2,up7], axis = 4)
    ...
    up8 = Conv3D(32, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling3D(size = (2,2,1))(conv7))
    merge8 = concatenate([conv1,up8], axis = 4)
    ...
    conv10 = Conv3D(16, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv8)
    conv10 = Conv3D(4, 1, activation = 'softmax')(conv10)
...
def nano_unet(pretrained_weights = PRETRAINED_WEIGHTS,input_size = (TRAINING_IMAGE_SIZE[0],TRAINING_IMAGE_SIZE[1],TRAINING_IMAGE_SIZE[2],NUMBER_OF_CHANNELS)):
#     inputs = tf.random.normal(input_size)
    tf.random.set_seed(1234)
    inputs = Input(input_size, batch_size = BATCH_SIZE)
    ...
    up6 = Conv3D(32, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(upsampling3d(drop4))
    merge6 = concatenate([drop3,up6], axis = 4)
    ...
    up7 = Conv3D(16, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(upsampling3d(size = (2,2,1))(conv6))
    merge7 = concatenate([conv2,up7], axis = 4)
    ...
    up8 = Conv3D(8, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(upsampling3d(size = (2,2,1))(conv7))
    merge8 = concatenate([conv1,up8], axis = 4)
    ...
    conv10 = Conv3D(6, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv8)
    conv10 = Conv3D(4, 1, activation = 'softmax')(conv10)
